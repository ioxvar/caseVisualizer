...
# Function to check the validity of a case using Perplexity API
def check_case_validity(case_description):
    url = "https://api.perplexity.ai/chat/completions"
    
    headers = {
        "Authorization": "Bearer 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",  # Replace with your Perplexity API key
...
# Simulate the settlement negotiation process
def negotiate_settlement():
    # In this example, we simulate a 50/50 chance of settlement success
    # This logic can be enhanced based on the actual data you have
    return "Yes"  # Assume settlement was reached

# Simulate the court appearance process
def appear_in_court():
    # In this example, we simulate the court outcome
    return "Yes"  # Assume the court decision was successful
...
def generate_pyvis_graph(validity, settlement_outcome, court_outcome):
    ...
    # Save the graph to a temporary HTML file and return the file path
